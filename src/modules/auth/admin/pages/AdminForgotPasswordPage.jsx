      ...
      <AuthCard>
        ...
        <div>
          <h2 className="text-xl font-extrabold text-slate-800 tracking-tight flex items-center gap-2">
            <FiShield className="text-teal" /> Reset Admin Password
          </h2>
          <p className="text-[10px] text-slate-400 font-bold uppercase mt-1 tracking-wider">
            Enter your admin email to verify credential ownership.
          </p>
        </div>
        ...
        {success ? (
          <div className="p-4 bg-teal-light/50 border border-teal/20 rounded-3xl text-center flex flex-col gap-2">
            ...
            <p className="text-[10px] text-slate-500">Redirecting to two-factor verify-otp page...</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            
            <AuthInput
              label="Registered Administrator Email"
              type="email"
            ...
            <div className="flex justify-center mt-2 border-t border-slate-50 pt-4">
              ...
              >
                <FiArrowLeft /> Back to Admin Login
              </Link>
            </div>
